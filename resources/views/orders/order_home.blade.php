        ...
        <div class="card card-order text-center" >
            ...
            <div class="card-footer bg-white ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"><input class="form-control order-input" type="text" name="enterprise" value="{{$user->health->health_name ?? null }}"></div>

                    <div class="col-md-2">االهاتف</div>
                    <div class="col-md-3"><input class="form-control order-input" type="text" name="phone" value="{{$user->health->health_mobile ?? null}}" ></div>                
                </div>
            </div>
            <div class="row m-2 ">
                <div class="col-md-2">الدولة</div>
                <div class="col-md-2"><input class="form-control order-input" type="text" name="country" value="{{$user->health->company_name ?? null}}" ></div>
